...
void EUTelMille2::findtracks2(
                            ...
                            IntVec vec,
                            std::vector<std::vector<EUTelMille2::HitsInPlane> > &_allHitsArray,
                            unsigned int i,
                            int y
                            )
{
...
void EUTelMille2::findtracks(
                            std::vector<IntVec > &indexarray,
                            IntVec vec,
                            std::vector<std::vector<EUTelMille2::HitsInPlane> > &_hitsArray,
                            int i,
                            int y
                            )
{
 ...
 * 
 */
void EUTelMille2::FitTrack(unsigned int nPlanesFitter, double xPosFitter[], double yPosFitter[], double zPosFitter[], double xResFitter[], double yResFitter[], double chi2Fit[2], double residXFit[], 
