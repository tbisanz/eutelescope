 ...
 *
 */
#ifndef EUTelProcessorTimeCut_h 
#define EUTelProcessorTimeCut_h
...
namespace eutelescope {
  ...
  class EUTelProcessorTimeCut : public marlin::Processor {

  public:
    //! Returns a new instance of EUTelProcessorTimeCut
    /*! This method returns an new instance of the this processor.  It
     *  is called by Marlin execution framework and it shouldn't be
     *  called/used by the final user.
     *
     *  @return a new EUTelProcessorTimeCut.
     */
    virtual Processor *newProcessor() {
      return new EUTelProcessorTimeCut;
    }

    //! Default constructor
    EUTelProcessorTimeCut();
  ...
  EUTelProcessorTimeCut gEUTelProcessorTimeCut;

} // namespace eutelescope

#endif // EUTelProcessorTimeCut_H
